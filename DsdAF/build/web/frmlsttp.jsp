...
try {
	...
	org.tempuri.TPListas service = new org.tempuri.TPListas();
	org.tempuri.ITPListas port = service.getBasicHttpBindingITPListas();
	Integer trainig = Integer.valueOf(0);
	String str = port.listarTP(trainig);
    
	DsdAFListar.TPListas service = new DsdAFListar.TPListas();
	DsdAFListar.ITPListas port = service.getBasicHttpBindingITPListas();
	java.lang.Integer trainig = Integer.valueOf(0);
	java.lang.String str = port.listarTP(trainig);
*/        
	DsdAFListar.TPListas service = new DsdAFListar.TPListas();
	DsdAFListar.ITPListas port = service.getBasicHttpBindingITPListas();
	java.lang.Integer trainig = Integer.valueOf(0);
